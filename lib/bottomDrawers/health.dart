...
Future<Post> fetchPostHealth() async {
  final response = await http.get(
      'https://newsapi.org/v2/top-headlines?country=in&category=health&apiKey=47ada2986be0434699996aaf4902169b');
...
class Health extends StatelessWidget {
  ...
  Health({Key key, this.post}) : super(key: key);
